...
EOT;
	...
	public function add_buyer_rating() {
		...
		foreach ($sel_proposal_reviews as $row_proposals_reviews ) {
		...
		// $avg = $total / count($ratings); //## mehdi
		$avg = ( $total / (count($ratings) * 5) * 100); //## mehdi
		// $updated_propoasl_rating = substr($avg, 0, 1);  //## mehdi
		...
		// $update_proposal_rating = $this->db->update("proposals", array("proposal_rating" => $updated_propoasl_rating), array("proposal_id" => $proposal_id)); //## mehdi
		$update_proposal_rating = $this->db->update("proposals", array("proposal_rating" => $avg), array("proposal_id" => $proposal_id));
