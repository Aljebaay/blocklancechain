...
require_once $platformRoot . "/functions/processing_fee.php";
      ...
      <div class="modal-content">
         ...
         <div class="payment-options-list">
            ...
            if($enable_2checkout == "yes"){ 
               include $platformRoot . "/plugins/paymentGateway/paymentMethod2.php";
            } 
            ?>
         ...
         <button class="btn btn-secondary" data-dismiss="modal"> Close </button>
            ...
            <?php 
               if($enable_dusupay == "yes"){
                  ...
                  include $platformRoot . "/includes/comp/dusupay_method2.php";
               }
            ?>
...
<?php include $platformRoot . "/includes/comp/dusupay_payment_modal.php"; ?>
