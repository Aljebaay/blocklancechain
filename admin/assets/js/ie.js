...
function handle(t, o) {
    ...
    0 !== t._state ? (t._handled = !0, Promise._immediateFn(function () {
        ...
        if (null !== e) {
            ...
            resolve(o.promise, n)
        } else(1 === t._state ? resolve : reject)(o.promise, t._value)
    })) : t._deferreds.push(o)
}
...
function resolve(n, e) {
    try {
        ...
        if (e && ("object" == typeof e || "function" == typeof e)) {
            var t = e.then;
            if (e instanceof Promise) return n._state = 3, n._value = e, void finale(n);
            if ("function" == typeof t) return void doResolve(bind(t, e), n)
        }
...
Promise.prototype.catch = function (e) {
...
}, Promise.prototype.finally = finallyConstructor, Promise.all = function (n) {
    ...
    return n && "object" == typeof n && n.constructor === Promise ? n : new Promise(function (e) {
        e(n)
    })
