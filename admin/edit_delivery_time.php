            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><i class="menu-icon fa fa-comments"></i> Delivery Time </h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Edit Delivery Time</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="delivery_title" class="form-control" value="<?= $delivery_title; ?>" required>

                                <small class="form-text text-muted">

                                This delivery title will show on categories, sub categories and search related pages.
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="delivery_proposal_title" class="form-control" value="<?= $delivery_proposal_title; ?>" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="submit" name="update_delivery_time" value="Update Delivery Time" class="btn btn-success form-control">
