                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <ul class="pagination">
                                ...
                                for (; $i < min($page + 6, $total_pages); $i++) {
                                    ...
                                    echo "'><a href='index?view_buyer_reviews=" . $i . "' class='page-link'>" . $i . "</a></li>";
                                }
                                ...
                                if ($total_pages > 1) {
                                    echo "<li class='page-item " . ($total_pages == $page ? "active" : "") . "'><a class='page-link' href='index?view_buyer_reviews=$total_pages'>$total_pages</a></li>";
                                }
