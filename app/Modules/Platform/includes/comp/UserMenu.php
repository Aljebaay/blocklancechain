...
<li class="logged-in-link">
  ...
  <span class="gig-zone-icon nav-icon gig-zone-icon-relative"><?php include("{$dir}images/svg/notification.svg"); ?></span>
...
<li class="logged-in-link">
  ...
  <span class="gig-zone-icon nav-icon gig-zone-icon-relative"><?php include("{$dir}images/svg/email.svg"); ?></span>
...
<li class="logged-in-link">
  ...
  <span class="gig-zone-icon nav-icon gig-zone-icon-relative"><?php include("{$dir}images/svg/heart.svg"); ?> </span>
  <span>
...
<li class="logged-in-link">
  ...
  <span class="gig-zone-icon nav-icon gig-zone-icon-relative"><?php include("{$dir}images/svg/basket.svg"); ?></span>
  <?php if($count_cart > 0){ ?>
