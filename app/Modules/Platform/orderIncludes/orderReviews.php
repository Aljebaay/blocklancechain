            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    if (isset($_POST['buyer_review_submit'])) {
                        ...
                        $update_proposal_rating = $db->update("proposals", array("proposal_rating" => $avg), array("proposal_id" => $proposal_id));  //## mehdi
                        $update_seller_rating = $db->update("sellers", array("seller_rating" => $avg), array("seller_id" => $proposal_seller_id));
