...
<?php 
require_once $platformRoot . "/includes/user_header.php"; 
...
<div class="container-fluid mt-5 mb-5">
  ...
  <div class="row"><!--- row Starts --->
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 request-sidebar"><!--- col-xl-3 col-md-2 request-sidebar Starts --->
		  <?php include $platformRoot . "/includes/request_sidebar.php"; ?>
...
?>
<?php require_once $platformRoot . "/includes/footer.php"; ?>
</body>
</html>