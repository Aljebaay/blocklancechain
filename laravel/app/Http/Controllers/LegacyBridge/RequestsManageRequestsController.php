...
class RequestsManageRequestsController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        $script = base_path('..' . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . 'requests' . DIRECTORY_SEPARATOR . 'manage_requests.php');
        $result = LegacyScriptRunner::run($request, $script, '/requests/manage_requests');
