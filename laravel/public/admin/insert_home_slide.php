        ...
        <?php } ?>
            ...
            <div class="card"><!--- card Starts --->
                ...
                <div class="card-header"><!--- card-header Starts --->
                    ...
                    <h4 class="h4">Insert New Slide</h4>
...
if(isset($_POST['submit'])){
    ...
    if($val->run() == false){
        ...
        echo "<script> window.open('index?insert_home_slide','_self');</script>";
        ...
        if(!in_array($file_extension,$allowed)){
            ...
            $insert_slide = $db->insert("home_section_slider",array("slide_name" => $slide_name,"slide_image" => $slide_image,"isS3"=>$enable_s3));

            if($insert_slide){
            	
                $insert_id = $db->lastInsertId();
                $insert_log = $db->insert_log($admin_id,"home_slide",$insert_id,"inserted");
